...
def createCaseEdgeTable():
  ...
  caseEdgeTable[4] = [0,1]
  caseEdgeTable[5] = [0,2]
  caseEdgeTable[6] = [[0,3][1,2],[0,1][2,3]]
  caseEdgeTable[7] = [0,3]
  caseEdgeTable[8] = [0,3]
  caseEdgeTable[9] = [[0,3][1,2],[0,1][2,3]]
  caseEdgeTable[10] = [0,2]
  caseEdgeTable[11] = [0,1]
  caseEdgeTable[12] = [1,3]
  caseEdgeTable[13] = [2,3]
  caseEdgeTable[14] = [1,2]
  caseEdgeTable[15] = []
